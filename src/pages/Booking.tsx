...
export default function Booking() {
  ...
  const depositAmount = estimatedTotal * 0.6;
      ...
      if (booking) {
        const clientEmailHtml = `
          <div style="font-family:'Montserrat',sans-serif;max-width:600px;margin:0 auto;background:#fff;padding:40px;border:1px solid #e8e0d4;">
            ...
            <p style="color:#444;font-size:14px;">Thank you for booking with <strong>JT Studios & Events</strong>. Your booking has been received and is awaiting your 60% deposit to confirm your date.</p>
            <table style="width:100%;border-collapse:collapse;margin:24px 0;">
              ...
              <tr><td style="padding:8px 0;color:#888;font-size:12px;border-bottom:1px solid #eee;">Deposit Due (60%)</td><td style="padding:8px 0;font-size:12px;font-weight:600;color:#7a5a1e;border-bottom:1px solid #eee;">£${depositAmount.toFixed(2)}</td></tr>
            ...
            <p style="color:#444;font-size:13px;">You will be redirected to our secure payment page to pay your 60% deposit. If not, please contact us at <a href="mailto:bookings@jtstudios.events" style="color:#7a5a1e;">bookings@jtstudios.events</a>.</p>
        ...
        const adminEmailHtml = `
          <div style="font-family:'Montserrat',sans-serif;max-width:600px;margin:0 auto;background:#fff;padding:40px;border:1px solid #e8e0d4;">
            ...
            <table style="width:100%;border-collapse:collapse;margin:16px 0;">
              ...
              <tr><td style="padding:8px 0;color:#888;font-size:12px;border-bottom:1px solid #eee;">Event Type</td><td style="padding:8px 0;font-size:12px;border-bottom:1px solid #eee;">${form.event_type}</td></tr>
              <tr><td style="padding:8px 0;color:#888;font-size:12px;border-bottom:1px solid #eee;">Location</td><td style="padding:8px 0;font-size:12px;border-bottom:1px solid #eee;">${form.location}</td></tr>
              <tr><td style="padding:8px 0;color:#888;font-size:12px;border-bottom:1px solid #eee;">Deposit (60%)</td><td style="padding:8px 0;font-size:12px;font-weight:600;color:#7a5a1e;border-bottom:1px solid #eee;">£${depositAmount.toFixed(2)}</td></tr>
    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="pt-32 pb-10 text-center px-6">
        ...
        <p className="font-body text-muted-foreground text-sm max-w-lg mx-auto">
          Complete the form below. A 60% deposit via Stripe secures your date — remaining balance due on completion.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 pb-24 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            {loading ? "Processing..." : "Confirm & Pay 60% Deposit"}
          </button>
        </form>
              ...
              {selectedService ? (
                <>
                  ...
                  <div className="border-t border-border pt-4">
                    ...
                    <div className="flex justify-between mb-2">
                      <span className="font-body text-xs text-primary">60% Deposit (due now)</span>
